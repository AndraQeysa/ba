...
{
    $sql = "SELECT id_buku, judul buku FORM buku";
    $res = myslqi_querry($kon,$sql);
...
function ambilPeminjaman($kon, $id_pinjam)
{
    ...
    anggota.id_anggota INNER JOIN buku ON peminjaman.id_buku = buku.id_buku Where
    id_pinjam = $id_pinjam";
